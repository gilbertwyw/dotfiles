...
local custom_lsp_attach = function(client)
  ...
  vim.api.nvim_buf_set_keymap(0, 'n', '<localeader>ga', '<cmd>lua vim.lsp.buf.code_action()<CR>', {noremap = true})
  vim.api.nvim_buf_set_keymap(0, 'n', '<localeader>gd', '<cmd>lua vim.lsp.buf.declaration()<CR>', {noremap = true})
  vim.api.nvim_buf_set_keymap(0, 'n', '<localeader>gi', '<cmd>lua vim.lsp.buf.implementation()<CR>', {noremap = true})
  vim.api.nvim_buf_set_keymap(0, 'n', '<localeader>gr', '<cmd>lua vim.lsp.buf.references()<CR>', {noremap = true})
  vim.api.nvim_buf_set_keymap(0, 'n', '<localeader>gt', '<cmd>lua vim.lsp.buf.type_definition()<CR>', {noremap = true})
